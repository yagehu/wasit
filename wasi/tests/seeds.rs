...
fn main() -> Result<(), eyre::Error> {
    ...
    let cases = [
        ...
        Case {
            seed:   "11-fd_fdstat_set_flags.json",
            spec:   "preview1.witx",
            assert: Box::new(|run| {
                let action = run
                    .prog
        ...
        Case {
            seed:   "12-fd_fdstat_set_rights.json",
            spec:   "preview1.witx",
            assert: Box::new(|run| {
                let action = run
                    .prog
        ...
        Case {
            seed:   "14-fd_filestat_set_size.json",
            spec:   "preview1.witx",
            assert: Box::new(|run| {
                let action = run
                    .prog
        ...
        Case {
            seed:   "18-fd_prestat_dir_name.json",
            spec:   "preview1.witx",
            assert: Box::new(|run| {
                let action = run
                    .prog
